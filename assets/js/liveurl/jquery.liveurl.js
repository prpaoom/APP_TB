 ...
 */
//console.log(strip('http://www.kapook.com/&nbsp;'));
        ...
        liveUrl : function( options) 
        {
            var defaults = 
            {
                meta: [
                    ...
                    ['video','property', 'og:type'],
                    ['video_type','property', 'og:video:type'],
                    ['video_url','property', 'og:video:url'],
            ...
            this.each(function() 
            {
                ...
                {                
                    // read all links   
                    var links = $.urlHelper.getLinks($(self).html());
                    if(links != null){
	                    //console.log( strip( $.urlHelper.getLinks($(self).html())[0] ) );
						var links = [$.urlHelper.getLinks($(self).html())[0].replace(/&nbsp;/gi,'').replace(/(<([^>]+)>)/ig,'')];
	                    //console.log(links)
                    }
                ...
                core.getPreview = function(data, uri)
                {
                    ...
                    if (data.video != null) {
                        data.video = {
                            file  :   preview.video,
                            v_url : (typeof preview.video_url   != not) ? preview.video_url  : '',
